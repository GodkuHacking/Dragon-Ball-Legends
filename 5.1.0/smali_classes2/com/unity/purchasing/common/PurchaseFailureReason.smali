...
.method static constructor <clinit>()V
    ...
    const-string v3, "ExistingPurchasePending"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/unity/purchasing/common/PurchaseFailureReason;->ItemUnavailable:Lcom/unity/purchasing/common/PurchaseFailureReason;

    .line 10
    new-instance v5, Lcom/unity/purchasing/common/PurchaseFailureReason;

    const-string v7, "SignatureInvalid"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/unity/purchasing/common/PurchaseFailureReason;->SignatureInvalid:Lcom/unity/purchasing/common/PurchaseFailureReason;

    .line 11
    new-instance v7, Lcom/unity/purchasing/common/PurchaseFailureReason;

    const-string v9, "UserCancelled"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/unity/purchasing/common/PurchaseFailureReason;->UserCancelled:Lcom/unity/purchasing/common/PurchaseFailureReason;

    .line 12
    new-instance v9, Lcom/unity/purchasing/common/PurchaseFailureReason;

    const-string v11, "PaymentDeclined"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/unity/purchasing/common/PurchaseFailureReason;->PaymentDeclined:Lcom/unity/purchasing/common/PurchaseFailureReason;

    .line 13
    new-instance v11, Lcom/unity/purchasing/common/PurchaseFailureReason;

    const-string v13, "DuplicateTransaction"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/unity/purchasing/common/PurchaseFailureReason;->DuplicateTransaction:Lcom/unity/purchasing/common/PurchaseFailureReason;

    .line 14
    new-instance v13, Lcom/unity/purchasing/common/PurchaseFailureReason;

    const-string v15, "Unknown"

    const/4 v14, 0x7

    invoke-direct {v13, v15, v14}, Lcom/unity/purchasing/common/PurchaseFailureReason;-><init>(Ljava/lang/String;I)V

    sput-object v13, Lcom/unity/purchasing/common/PurchaseFailureReason;->Unknown:Lcom/unity/purchasing/common/PurchaseFailureReason;

    const/16 v15, 0x8

    new-array v15, v15, [Lcom/unity/purchasing/common/PurchaseFailureReason;
    ...
    .line 6
    sput-object v15, Lcom/unity/purchasing/common/PurchaseFailureReason;->$VALUES:[Lcom/unity/purchasing/common/PurchaseFailureReason;
